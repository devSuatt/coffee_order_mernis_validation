...
public class ISUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ISUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ISUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ISUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ISUDateTimeConverter dateTimeConverter = new ISUStandardDateTimeConverter();

    public ISUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ISUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ISUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ISUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ISUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ISUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
