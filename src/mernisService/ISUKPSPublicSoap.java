...
public class ISUKPSPublicSoap
{
    ...
    public ISUKPSPublicSoap(){}

    public ISUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ISUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ISUExtendedSoapSerializationEnvelope envelope= new ISUExtendedSoapSerializationEnvelope(ISUExtendedSoapSerializationEnvelope.VER11);
